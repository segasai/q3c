...
RETURNS internal AS 'MODULE_PATHNAME', 'q3c_radial_query_support'
...
CREATE OR REPLACE FUNCTION q3c_radial_query_base(
real, real, double precision, double precision, double precision)
RETURNS boolean AS 'MODULE_PATHNAME', 'pgq3c_radial_query_real'
LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;

CREATE OR REPLACE FUNCTION q3c_radial_query(
real, real, double precision, double precision, double precision)
RETURNS boolean AS 'MODULE_PATHNAME', 'pgq3c_radial_query_real'
LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT SUPPORT q3c_radial_query_support;

CREATE OR REPLACE FUNCTION q3c_radial_query_base(
double precision, double precision, double precision, double precision, double precision)
RETURNS boolean AS 'MODULE_PATHNAME', 'pgq3c_radial_query'
LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
